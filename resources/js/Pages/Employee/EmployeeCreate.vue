                ...
                <Card class="!mt-0">
                        ...
                        <form @submit.prevent="submit" class="form">
                            <div class="grid grid-cols-2 gap-8">
                                ...
                                <div>
                                    <InputLabel for="employee_id" :value="__('Employee ID')"/>
                                    <TextInput
                                        id="employee_id"
                                        type="number"
                                        class="mt-1 block w-full"
                                        :class="{'border border-red-500': form.errors.employee_id}"
                            ...
                            <div class="mt-4">
                                ...
                                <TextInput
                                    ...
                                    required
                                    autocomplete="off"
                                    :placeholder="__('123, Cavite, Philippines')"
                                />
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        required
                                                        autocomplete="off"
                                                        :placeholder="__('Cavite, Philippines')"
                                                    />
