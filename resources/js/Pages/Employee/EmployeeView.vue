            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Card class="!mt-0">
                    ...
                    <DescriptionList>
                        ...
                        <DescriptionListItem colored>
                            <DT>{{__('Gender')}}</DT>
                            <DD>{{ extractPersonalDetails(employee.employee_id).isMale ? __('Male') : __('Female') }}</DD>
                        </DescriptionListItem>
                        ...
                        <DescriptionListItem>
                            <DT>{{__('Birthday')}}</DT>
                            <DD>{{
                                extractPersonalDetails(employee.employee_id).date_localized +
                                ' - ' + useAgeCalculator(extractPersonalDetails(employee.employee_id).date) + ' ' + __('Years')
                              }}</DD>
                        </DescriptionListItem>
