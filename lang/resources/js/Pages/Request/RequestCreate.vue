            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Card class="!mt-0">
                    ...
                    <form @submit.prevent="submitForm">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4" v-if="$page.props.auth.user.roles.includes('admin')">
                            <div>
                                <InputLabel for="receiver_id" :value="__('Receiver')"/>
                                <select id="receiver_id" class="fancy-selector" v-model="form.receiver_id">
                                    <option value="0">{{ __('Choose an Employee to receive') }}</option>
