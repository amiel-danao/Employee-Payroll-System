                ...
                <Card class="!mt-0">
                    <div>
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div v-if="($page.props.auth.user.roles.includes('admin') && receiver == null) || (receiver != null && $page.props.auth.user.id == receiver.id)" class="flex inline-flex gap-4">
                        ...
                        <DescriptionList>
                            ...
                            <DescriptionListItem colored>
                                <DT>{{__('Receiver')}}</DT>
                                <DD>{{ receiver != null? receiver.name : __('N/A') }}</DD>
                            </DescriptionListItem>
